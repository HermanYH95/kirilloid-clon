...
var units = (function () {
  ...
  //         = 0                  # settlers
  var units = [
  [ {off:50, def_i:40, def_c:70, speed:7, cost:[  100,   80,  130,   30], cu:1, time: 1360, cap:50,  type:'i', prod: 20, mask:5, rs_time:6900},
    {off:30, def_i:65, def_c:35, speed:6, cost:[  100,  120,  150,   60], cu:1, time: 2200, cap:20,  type:'i', prod: 20, mask:2, rs_time:8400},
    {off:75, def_i:40, def_c:25, speed:7, cost:[  150,  160,  210,   80], cu:1, time: 2400, cap:50,  type:'i', prod: 20, mask:1, rs_time:9000},
    {off:0,  def_i:20, def_c:10, speed:16,cost:[  140,  160,   20,   40], cu:2, time: 1700, cap:0,   type:'c', prod: 21, mask:48,rs_time:6900},
    {off:130,def_i:65, def_c:50, speed:15,cost:[  480,  380,  280,   80], cu:3, time: 3300, cap:100, type:'c', prod: 21, mask:1, rs_time:11700},
    {off:195,def_i:80, def_c:105,speed:10,cost:[  550,  640,  800,  180], cu:4, time: 4400, cap:70,  type:'c', prod: 21, mask:1, rs_time:15000},
  ...
  [ {off:40, def_i:20, def_c:5,  speed:7, cost:[   95,   75,   40,   40], cu:1, time:  900, cap:60,  type:'i', prod: 20, mask:1, rs_time:4500},
    ...
    {off:65, def_i:30, def_c:30, speed:7, cost:[  130,  120,  170,   70], cu:1, time: 1500, cap:50,  type:'i', prod: 20, mask:1, rs_time:6300},
    {off:0,  def_i:10, def_c:5,  speed:9, cost:[  160,  100,   50,   50], cu:1, time: 1400, cap:0,   type:'c', prod: 20, mask:48,rs_time:6000, prod_type:'i'},
    {off:90, def_i:100,def_c:40, speed:14,cost:[  370,  270,  290,   75], cu:2, time: 3000, cap:110, type:'c', prod: 21, mask:2, rs_time:10800},
    {off:150,def_i:50, def_c:75, speed:12,cost:[  450,  515,  480,   80], cu:3, time: 3700, cap:80,  type:'c', prod: 21, mask:1, rs_time:12900},
  ...
  [ {off:15, def_i:40, def_c:50, speed:7, cost:[  100, 130,   55,    30], cu:1, time: 1300, cap:35,  type:'i', prod: 20, mask:6, rs_time:5700},
    {off:70, def_i:35, def_c:20, speed:7, cost:[  140, 150,  185,    60], cu:1, time: 1800, cap:45,  type:'i', prod: 20, mask:1, rs_time:7200},
    {off:0,  def_i:20, def_c:10, speed:17,cost:[  170, 150,   20,    40], cu:2, time: 1700, cap:0,   type:'c', prod: 21, mask:48,rs_time:6900},
    {off:110,def_i:25, def_c:40, speed:19,cost:[  320, 415,  210,    55], cu:2, time: 3100, cap:75,  type:'c', prod: 21, mask:1, rs_time:11100},
    {off:45, def_i:115,def_c:55, speed:16,cost:[  360, 330,  280,   120], cu:2, time: 3200, cap:35,  type:'c', prod: 21, mask:2, rs_time:11400},
    {off:150,def_i:65, def_c:165,speed:13,cost:[  485, 600,  650,   165], cu:3, time: 3900, cap:65,  type:'c', prod: 21, mask:5, rs_time:13500},
  ...
  [ {off:50, def_i:35, def_c:30, speed:6, cost:[  110,  185,  110,   35], cu:1, time: 1700, cap:60,  type:'i', prod: 20, mask:7, rs_time:6900},
    {off:0,  def_i:40, def_c:22, speed:9, cost:[  185,  150,   35,   75], cu:1, time: 1232, cap:0,   type:'i', prod: 20, mask:48,rs_time:5496},
    {off:40, def_i:85, def_c:45, speed:8, cost:[  145,   95,  245,   45], cu:1, time: 1936, cap:40,  type:'i', prod: 20, mask:2, rs_time:7608},
    {off:90, def_i:55, def_c:40, speed:6, cost:[  130,  200,  400,   65], cu:1, time: 2112, cap:50,  type:'i', prod: 20, mask:1, rs_time:8136},
    {off:55, def_i:120,def_c:90, speed:16,cost:[  555,  445,  330,  110], cu:2, time: 2816, cap:110, type:'c', prod: 21, mask:6, rs_time:10248},
    {off:195,def_i:80, def_c:75, speed:9, cost:[  660,  495,  995,  165], cu:3, time: 3432, cap:80,  type:'c', prod: 21, mask:1, rs_time:12096},
    {off:65, def_i:30, def_c:80, speed:4, cost:[  525,  260,  790,  130], cu:3, time: 4620, cap:0,   type:'i', prod: 22, mask:65,rs_time:15660},
    {off:50, def_i:60, def_c:10, speed:3, cost:[  550, 1240,  825,  135], cu:6, time: 9900, cap:0,   type:'i', prod: 22, mask:65,rs_time:28800},
    {off:40, def_i:60, def_c:40, speed:4, cost:[33450,30665,36240,13935], cu:4, time:77550, cap:0,   type:'i', prod: 26, mask:0, rs_time:21188, loyality:[20,25]},
    {off:10, def_i:80, def_c:80, speed:5, cost:[ 5115, 5580, 6045, 3255], cu:1, time:34100, cap:3000,type:'i', prod: 26, mask:0, rs_time:0}
  ],
  [ {off:45, def_i:22, def_c:5,  speed:7, cost:[   95,   80,   50,   40], cu:1, time:  800, cap:55,  type:'i', prod: 20, mask:1, rs_time:4200},
    {off:20, def_i:50, def_c:30, speed:7, cost:[  125,   70,   85,   40], cu:1, time: 1080, cap:40,  type:'i', prod: 20, mask:2, rs_time:5040},
    {off:70, def_i:30, def_c:25, speed:5, cost:[  235,  220,  200,   70], cu:2, time: 1550, cap:75,  type:'i', prod: 20, mask:1, rs_time:6450},
    {off:0,  def_i:10, def_c:5,  speed:9, cost:[  155,   95,   50,   50], cu:1, time: 1120, cap:0,   type:'i', prod: 20, mask:48,rs_time:5160},
    {off:45, def_i:95, def_c:100,speed:12,cost:[  385,  295,  290,   85], cu:2, time: 2650, cap:110, type:'c', prod: 21, mask:5, rs_time:9750},
    {off:160,def_i:50, def_c:75, speed:9, cost:[  475,  535,  515,  100], cu:2, time: 3060, cap:80,  type:'c', prod: 21, mask:1, rs_time:10980},
    {off:65, def_i:30, def_c:80, speed:4, cost:[  950,  325,  375,   70], cu:2, time: 4200, cap:0,   type:'i', prod: 22, mask:65,rs_time:13680},
    {off:50, def_i:60, def_c:10, speed:3, cost:[  850, 1225,  625,   60], cu:6, time: 9000, cap:0,   type:'i', prod: 22, mask:65,rs_time:28800},
    {off:40, def_i:40, def_c:60, speed:5, cost:[35500,26600,25000,27200], cu:4, time:70500, cap:0,   type:'i', prod: 26, mask:0, rs_time:19425, loyality:[15,30]},
    {off:10, def_i:80, def_c:80, speed:5, cost:[ 5800, 4600, 4800, 4800], cu:1, time:31000, cap:3000,type:'i', prod: 26, mask:0, rs_time:0}
  ],
  ];
